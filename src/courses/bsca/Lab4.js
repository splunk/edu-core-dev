...
const step20 = `/opt/splunk/bin/splunk restart`;
    ...
    return(<div style={{margin:50}}>
        ...
        <Solution step="4" code={step4} language="language-bash"/>
        <Solution step="5" code={step5} language="language-xml"/>
        <Solution step="6" code={step6} language="language-python"/>
        <Solution step="7" code={step7} language="language-python"/>
        <Solution step="8" code={step8} language="language-python"/>
        <Solution step="12" code={step12} language="language-bash"/>
        <Solution step="13" code={step13} language="language-solution-file"/>

...
import Ship from '@splunk/react-icons/Ship';`}
      ...
      <Snippet step="18" language="jsx" code={`, StyledSidebar`} />
...
export { StyledContainer, sectionTitle };`}
      ...
      <Snippet step="27" language="jsx" code={`, sectionTitle`} />
...
import Inventory from '@splunk/inventory';`}
      ...
      <Snippet step="34" language="jsx" code={`<Overview />`} />

      <Snippet step="35" language="jsx" code={`<Inventory />`} />
    </div>
  );
}
